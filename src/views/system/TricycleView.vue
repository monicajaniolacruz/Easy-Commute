    ...
    return {
      routes: [
        ...
        },
        {
          ...
          barangays: [
            //W-1
            { name: 'Butuan-Masao Road' },
            { name: 'Emily Homes Butuan City' },
            { name: 'FSUU Morelos Campus' },
            { name: 'Happy Homes Butuan City' },
            { name: 'Ambago Butuan City' },
            //W-2
            { name: 'Casa Rivera Homes' },
            { name: 'Ram-City Homes Butuan City' },
            { name: 'Employees Village  Butuan City' },
            //W-3
            { name: 'Butuan City Sports Complex' },
            { name: 'Bonbon Butuan City' },
            { name: 'Kinamlutan Butuan City' },
            //W-4
            { name: 'Santo Niño Shrine' },
            { name: 'Agusan del Norte Provincial Hospital' },
            { name: 'Employees Village Butuan City' },
            //W-5
            { name: 'Paradise Village Road' },
            { name: 'Furia Village' },
            { name: 'Balangay Shrine Museum Butuan City' },
            { name: 'BLISS Butuan City' },
            //W-6
            { name: 'Bancasi Covered Court Butuan City' },
        ...
        },
        {
          ...
          barangays: [
            ...
            { name: 'Buhangin Butuan City' },
            //E-2
            { name: 'Baan Km. 3 Butuan City' },
            { name: 'IRA Butuan City' },
            { name: 'Lemon Butuan City' },
            //E-3
            { name: 'PIP Pharma and Medical Supplies' },
            { name: 'Cabcabon Butuan City' },
            { name: 'Bobon Butuan City' },
            //E-4
            { name: 'Taligaman National High School' },
            { name: 'Basag Butuan City' },
            { name: 'Ampayon Public Market' },
            //E-5
            { name: 'Veross Convinience Store' },
            { name: 'Ampayon Public Market' },
            { name: 'Purok 3A Basketball Court Butuan City' },
            { name: 'Caraga State University' },
            //E-6
            { name: 'Camayahan Butuan City' },
            { name: 'Basag Butuan City' },
            { name: 'Ampayon Public Market' },
          ],
        },
